# Vastu Vaibhav Services Catalog

**Geographical Scope & Travel Logistics**
Vastu Vaibhav operates exclusively within the state of Goa, strictly offering in-person consultations to ensure the highest quality of service. Virtual or online consultations are not currently provided. Services in neighboring regions (e.g., Karnataka, Maharashtra) may be accommodated strictly on a case-by-case basis, provided the client arranges and covers all logistical and travel requirements.

**Disclaimer Regarding Plan Documentation**
Vastu Vaibhav provides expert Vastu consultations and markings. We do **not** draft, CAD design, or provide fresh architectural plan drawings. All recommendations and markings will be made directly onto existing physical or digital plans furnished by the client or the client's architect.
...
### 4. Interior & Exterior Element Placement
...
- **Interior Elements covered:** Sofas, TV Units, Dining Tables, Beds, Wardrobes, Study/Dressing Tables, Mirrors, Electrical Distribution Boards, etc.
- **Exterior Elements covered:** Gardens, Fountains, Swimming Pools, Meter Boxes, Septic Tanks, Borewells, Overhead/Underground Sump Tanks, Gates, Dustbins, etc.

**Fixed Charges:**
- Individual Item Suggestion: ₹ 500 per item.
- Comprehensive Interior Package: ₹ 2,500
- Comprehensive Exterior Package: ₹ 2,500
