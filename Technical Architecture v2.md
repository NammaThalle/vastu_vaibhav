...
* Historical bill PDF generation (snapshot-based)
* Secure authentication with 2FA

The system follows a ledger-based accounting model, not invoice-based accounting.

Initial deployment: Self-hosted home server.
Future-ready for cloud migration without schema changes.
