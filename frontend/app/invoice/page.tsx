  ...
  return (
    <div className="min-h-screen bg-stone-100 px-3 py-4 text-slate-900 print:bg-white print:p-0">
      <div className="mx-auto w-full max-w-[780px] overflow-hidden rounded-[18px] border border-slate-200 bg-white shadow-[0_14px_34px_rgba(15,23,42,0.06)] print:max-w-none print:rounded-none print:border-0 print:shadow-none">
        ...
        <div className="border-y border-slate-200 px-7 py-5">
          <div className="flex flex-wrap items-center gap-3 text-[12.5px] font-medium text-slate-700">
            {/* Primary Phone Bubble */}
            <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3.5 py-1.5 shadow-sm">
          ...
          {/* Address Partition */}
          <div className="mt-3.5 flex items-start gap-2.5 rounded-xl border border-slate-100 bg-slate-50/50 px-4 py-2.5 text-[12px] text-slate-500">
            ...
            <span className="leading-5">{invoice.company.address}</span>
          </div>
        </div>
